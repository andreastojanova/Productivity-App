  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-100 via-indigo-50 to-purple-100 p-5">
    <div class="max-w-6xl mx-auto">
      <div class="flex gap-2">
        <button v-if="!user" @click="goLogin" class="px-5 py-2.5 rounded-2xl bg-white border border-slate-200 text-slate-700 font-semibold shadow-sm hover:bg-slate-50 transition-all">
          Login
        </button>
        <button v-if="!user" @click="goRegister" class="px-8 py-2.5 rounded-2xl bg-indigo-500 hover:bg-indigo-600 text-white font-semibold transition-all duration-300 hover:scale-105 shadow-lg shadow-indigo-200">
           Register
        </button>
        <button v-if="user" @click="logout" class="px-8 py-2.5 rounded-2xl bg-indigo-500 hover:bg-indigo-600 text-white font-semibold transition-all duration-300 hover:scale-105 shadow-lg shadow-indigo-200">
            Logout
        </button>
      </div>
        ...
        <div class="p-2.5 w-1/2">
            ...
            >
              ...
              <p class="text-slate-500 mb-5">
                Sign in to save and view your focus statistics.
              </p>
